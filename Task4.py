...
# Initialize model, loss function, optimizer with L2 regularization
...
print(f"Training Accuracy (with L2): {train_acc*100:.2f}%")
print(f"Testing Accuracy (with L2): {test_acc*100:.2f}%")